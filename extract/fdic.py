...
def transform_location(): 
    ...
    location_df = aws_read_write.get_csv(bucket_name=S3_BUCKET_NAME, object_name='raw_data/location.csv')
...
def transform_financials():
    ...
    financials_df = aws_read_write.get_csv(bucket_name=S3_BUCKET_NAME, object_name=raw_s3_object_name)
